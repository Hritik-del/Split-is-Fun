...
public class ExpensesTabViewAdapter extends RecyclerView.Adapter<ExpensesTabViewAdapter.ExpenseDetailViewHolder> {
    ...
    private void deleteFromDatabase(BillEntity bill) {
        com.example.splitisfun.BillViewModel billViewModel = ViewModelProviders.of(ExpensesTabViewAdapter.this.thisOfExpenseFragment,new BillViewModelFactory(ExpensesTabViewAdapter.this.application,ExpensesTabViewAdapter.this.gName)).get(com.example.splitisfun.BillViewModel.class);
