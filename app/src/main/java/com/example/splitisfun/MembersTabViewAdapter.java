...
public class MembersTabViewAdapter extends RecyclerView.Adapter<com.example.splitisfun.MembersTabViewAdapter.MemberDetailViewHolder> {
    private OnItemClickListener listener;
    private List<com.example.splitisfun.MemberEntity> list = new ArrayList<>(); // maintain a list of all the existing members in the database
    boolean multiSelect = false; // true if user has selected any item
    List<com.example.splitisfun.MemberEntity> selectedItems = new ArrayList<>();
    ...
    private ActionMode.Callback actionModeCallbacks = new ActionMode.Callback() {
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            ...
            for(com.example.splitisfun.MemberEntity member: selectedItems) {
                list.remove(member);
    ...
    class MemberDetailViewHolder extends RecyclerView.ViewHolder {
        ...
        void update(final com.example.splitisfun.MemberEntity member) {
        ...
        void selectItem(com.example.splitisfun.MemberEntity member) {
            if (multiSelect) {
    ...
    void storeToList(List<com.example.splitisfun.MemberEntity> memberEntities) {
        list = memberEntities;
        notifyDataSetChanged();
    }

    private void deleteFromDatabase(com.example.splitisfun.MemberEntity member) {
    ...
    public interface OnItemClickListener {
        void onItemClick(com.example.splitisfun.MemberEntity member);
    }
