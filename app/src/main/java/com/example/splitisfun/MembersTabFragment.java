...
public class MembersTabFragment extends Fragment {
    ...
    private List<com.example.splitisfun.MemberEntity> members = new ArrayList<>();//maintain a list of all the existing members of the group from the database
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FloatingActionButton addFloating = view.findViewById(R.id.membersFragmentAdd);//floating action button for adding new member
        addFloating.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("requestCode", 1);//using requestCode(value = 1) to identity add member intent
                if(getActivity() != null){
        ...
        // create new MembersTAbViewAdapter.onItemClickListner interface object and pass it as a parameter
        //and pass it as a parameter to MembersTabViewAdapter.setOnItemClickListener method
        adapter.setOnItemClickListener(new MembersTabViewAdapter.OnItemClickListener() {


            @Override
            public void onItemClick(MemberEntity member) {
                //crate an edit member intent
                Intent intent = new Intent(getActivity(), AddEditMemberActivity.class);
                ...
                if(getActivity() != null) {
                    //launch the intent
                    getActivity().startActivityFromFragment(MembersTabFragment.this, intent, 2);
