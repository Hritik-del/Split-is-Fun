...
public class ExpensesTabFragment extends Fragment {
    ...
    private com.example.splitisfun.BillViewModel billViewModel;
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        billViewModel = ViewModelProviders.of(this,new BillViewModelFactory(getActivity().getApplication(),gName)).get(com.example.splitisfun.BillViewModel.class);
