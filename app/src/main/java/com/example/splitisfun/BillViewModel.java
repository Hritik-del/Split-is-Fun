...
import com.example.splitisfun.BillEntity;

import java.util.List;

public class BillViewModel extends AndroidViewModel {
    private com.example.splitisfun.BillRepository repository;
    private LiveData<List<BillEntity>> allBills;

    BillViewModel(@NonNull Application application,String gName) {
        super(application);
        repository = new com.example.splitisfun.BillRepository(application,gName);
