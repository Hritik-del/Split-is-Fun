...
public class CreateNewGroupActivity extends AppCompatActivity {
    ...
    private void saveGroup()
    {
        ...
        //create group objects that need to be inserted.
        ...
        for(GroupEntity item:groups) {
            ...
            //else store the group object in the database
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        menuInflater.inflate(R.menu.sava_group_bar_menu, menu);
        return true;
    }
    ...
    {
        //save the group to database if person clicks on save icon in the toolbar
        if(item.getItemId() == R.id.createNewGroupToolbarSaveGroupItem)
        {
            saveGroup();
        }
        finish(); // intiates finish if person clicks on back button
        return true;
    }
}
